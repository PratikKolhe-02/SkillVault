    ...
    <div>
      <div className='w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-[#00000047]  z-10'>
        ...
        <div className='w-[30%] lg:flex items-center justify-center gap-4 hidden'>
          ...
          {/* ✅ ADDED: Resume AI Button (Desktop) */}
          <span 
            className='px-[20px] py-[10px] border-2 border-white text-white rounded-[10px] text-[18px] font-light cursor-pointer hover:bg-white hover:text-black transition-all' 
      ...
      <div className={`fixed  top-0 w-[100vw] h-[100vh] bg-[#000000d6] flex items-center justify-center flex-col gap-5 z-10 ${showHam ? "translate-x-[0%] transition duration-600  ease-in-out" : "translate-x-[-100%] transition duration-600  ease-in-out"}`}>
        ...
        {/* ✅ ADDED: Resume AI Button (Mobile) */}
        <span className='flex items-center justify-center gap-2 text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[65px] py-[20px] text-[18px] ' onClick={() => navigate("/analyze-resume")}>Resume AI </span>
